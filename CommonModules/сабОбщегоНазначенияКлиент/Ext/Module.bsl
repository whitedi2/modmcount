...
Процедура сабРасшифроватьСуммуДДС(ЭтаФорма, Отчет, СтруктураПараметровРасшифровки) Экспорт
	...
	Если НЕ СтруктураПараметровРасшифровки.АналитикаБюджета = Неопределено Тогда
		СтандартныеОтчетыКлиентСервер.ДобавитьОтбор(ФормаПечати.Отчет.КомпоновщикНастроек, "АналитикаБюджета", 
		СтруктураПараметровРасшифровки.АналитикаБюджета, ?(ЗначениеЗаполнено(СтруктураПараметровРасшифровки.АналитикаБюджета), ВидСравненияКомпоновкиДанных.ВИерархии, ВидСравненияКомпоновкиДанных.Равно), Истина, 
		Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ);
	КонецЕсли;
