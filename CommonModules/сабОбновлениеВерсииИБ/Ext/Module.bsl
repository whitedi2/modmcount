...
Процедура НачальноеЗаполнениеПапокФайлов() Экспорт
	...
	НоваяПапка = Справочники.ПапкиФайлов.НайтиПоНаименованию("Общие файлы", Истина);
	...
	НоваяПапка = Справочники.ПапкиФайлов.НайтиПоНаименованию("Прикрепленные файлы", Истина);
	Если Не ЗначениеЗаполнено(НоваяПапка) Тогда
		НоваяПапка = Справочники.ПапкиФайлов.СоздатьЭлемент();
...
Функция СвойстваПрофиляПользователь()
	...
	Если Не ПрофильСуществует Тогда
		...
		ПрофильОбъект.Комментарий          = Результат.Комментарий;
		ПрофильОбъект.Назначение.Добавить().ТипПользователей = Справочники.Пользователи.ПустаяСсылка();
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДобавлениеИзменениеМоиЗадачи);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеНовостейРазделов);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеВидыОплатОрганизаций);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.БазовыеПраваБП);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ИспользованиеКомандДосьеКонтрагента);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ИспользованиеОбработкиОжидаемаяОплатаОтПокупателей);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеДанныхМонитораРуководителя);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеКонтрагентов);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеНоменклатуры);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеОрганизаций);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеСтатейДвиженияДенежныхСредств);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеШаблоновДоговоров);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ПодсистемаСправочники);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеГлобальныхДополнительныхОтчетовИОбработок);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеДанныхБухгалтерскогоУчета);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеОбщейБухгалтерскойНСИ);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеПодключаемогоОборудования);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеШаблоновЭтикеток);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеПлановОбменаСМобильнымиПриложениями);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.РаботаСЭлектроннойПочтойБП);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеПерсонализированныхДанных);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеДанныхПервичныхДокументов);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеШтрихкодовУпаковокТоваров);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.БазовыеПраваЗарплатаКадры);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеДанныхСотрудников);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеДолжностей);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеШаблоновДоговоров);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.БазовыеПраваБСП);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ВыводНаПринтерФайлБуферОбмена);
		...
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.СохранениеДанныхПользователя);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ИзменениеВыполнениеЗадач);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеКурсовВалют);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДобавлениеИзменениеЛичныхВариантовОтчетов);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеГрафиковРаботы);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеГлобальныхДополнительныхОтчетовИОбработок);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.РедактированиеПечатныхФорм);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДобавлениеИзменениеПапокИФайлов);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДобавлениеИзменениеРассылокОтчетов);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ИзменениеДополнительныхСведений);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ПросмотрСвязанныеДокументы);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.БазовыеПраваБТС);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.БазовыеПраваВЕТИС);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.БазовыеПраваГИСМ);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.БазовыеПраваЕГАИС);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.БазовыеПраваИПП);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеСкладов);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеСпискаФизическихЛиц);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеДатЗапретаЗагрузки);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ЧтениеДатЗапретаИзменения);
		...
		//ТекГруппаФайлов = Справочники.ПапкиФайлов.НайтиПоНаименованию("Общие файлы", Истина);
		//Если ЗначениеЗаполнено(ТекГруппаФайлов) Тогда
		//	
...
Функция СвойстваПрофиляУчастникДокументооборота()
	...
	Если Не ПрофильСуществует Тогда
		...
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДобавлениеИзменениеКонтрагентов);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДобавлениеИзменениеПапокИФайлов);
		// При обновлении ИБ важно, чтобы изменения уехали в подчиненный узел.
		ПрофильОбъект.Записать();
	КонецЕсли;
...
Функция СвойстваПрофиляФинансист()
	...
	Если Не ПрофильСуществует Тогда
		...
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДобавлениеИзменениеБанковскихСчетов);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДобавлениеИзменениеКонтрагентов);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДобавлениеИзменениеСроковОплатыДокументов);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДобавлениеИзменениеСчетовПокупателям);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДокументооборотЗаявкиНаОплату);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДокументооборотСлужебныеЗаписки);
		ПрофильОбъект.Роли.Добавить().Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.ДокументооборотСлужебныеЗапискиПросмотр);
		// При обновлении ИБ важно, чтобы изменения уехали в подчиненный узел.
