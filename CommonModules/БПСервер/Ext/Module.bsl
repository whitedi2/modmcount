	...
	ИначеЕсли ТипЗнч(ТекущееПП) = Тип("ДокументСсылка.УЧ_ДвижениеДС") Тогда
		Если ТипЗнч(ТекущееПП.ДокОснование) = Тип("ДокументСсылка.Д_ЗаявкаНаФинансирование") И ЗначениеЗаполнено(ТекущееПП.ДокОснование) Тогда
			...
			Иначе
				...
				КонецЦикла;
			КонецЕсли;
		ИначеЕсли ТипЗнч(ТекущееПП.ДокОснование) = Тип("ДокументСсылка.ПлатежноеПоручение") И ЗначениеЗаполнено(ТекущееПП.ДокОснование.Заявка) И ТипЗнч(ТекущееПП.ДокОснование.Заявка) = Тип("ДокументСсылка.Д_ЗаявкаНаФинансирование") Тогда
