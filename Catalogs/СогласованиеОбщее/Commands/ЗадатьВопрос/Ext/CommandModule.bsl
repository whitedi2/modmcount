...
Процедура ЗаполнитьНаСервере(ТекОбъект, ДанныеЗаполнения)
	...
	Если ЗначениеЗаполнено(ДанныеЗаполнения.Инициатор) И НЕ ДанныеЗаполнения.Инициатор = Справочники.Пользователи.НайтиПоНаименованию("Система", Истина) Тогда
		СтрокаИсполнителей.Исполнитель 	= ДанныеЗаполнения.Инициатор;
	ИначеЕсли ЗначениеЗаполнено(ДанныеЗаполнения.ЗадачаОт) И НЕ ДанныеЗаполнения.ЗадачаОт = Справочники.Пользователи.НайтиПоНаименованию("Система", Истина) Тогда
