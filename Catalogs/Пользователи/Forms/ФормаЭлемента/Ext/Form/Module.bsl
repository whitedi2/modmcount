...
Процедура УУ_ПриСозданииНаСервереПосле(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ТекЭл) И ТекЭл.Значение Тогда
		...
		РеквизитТекущаяДолжностьПользователя = Новый РеквизитФормы("РеквизитТекущаяДолжностьПользователя",Новый ОписаниеТипов("СправочникСсылка.Должности"), "", "Текущая дожность:");
		...
		РеквизитПодразделениеПользователя = Новый РеквизитФормы("РеквизитПодразделениеПользователя",Новый ОписаниеТипов("СправочникСсылка.СтруктураПредприятия"), "", "Подразделение:");
		...
		ДобавляемыеРеквизиты.Добавить(РеквизитПодразделениеПользователя);
		...
		ЭлементФормыПодразделениеПользователя = Элементы.Добавить("ЭлементФормыПодразделениеПользователя", Тип("ПолеФормы"), ГруппаДолжностиИОргСтруктура);
		ЭлементФормыПодразделениеПользователя.Вид = ВидПоляФормы.ПолеВвода;
		ЭлементФормыПодразделениеПользователя.ПутьКДанным = "РеквизитПодразделениеПользователя";
...
Процедура ЗаполнитьДолжностиИОргСтруктура()
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		ЭтаФорма.РеквизитПодразделениеПользователя = ВыборкаДетальныеЗаписи.СтруктурнаяЕдиница;		
	КонецЦикла;
