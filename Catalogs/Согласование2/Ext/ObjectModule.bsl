...
Процедура ПриЗаписи(Отказ)
	...
	Если (ТекТочкаМаршрута = "На подготовке" ИЛИ ТекТочкаМаршрута = Перечисления.СогласованиеОбщееТочкиМаршрута.НаПодготовке) И Не Завершен Тогда //старт процесса
		...
		Действие2ПередСозданиемЗадач(Перечисления.Согласование2ТочкиМаршрута.Действие2, ФормируемыеЗадачи, Истина);
		Если Не ФормируемыеЗадачи.Количество() Тогда
			Действие3ПередСозданиемЗадач(Перечисления.Согласование2ТочкиМаршрута.Действие3, ФормируемыеЗадачи, Истина);
		КонецЕсли;
		Если Не ФормируемыеЗадачи.Количество() Тогда
			Действие5ПередСозданиемЗадач(Перечисления.Согласование2ТочкиМаршрута.Действие5, ФормируемыеЗадачи, Истина);
		КонецЕсли;
		Если Не ФормируемыеЗадачи.Количество() Тогда
			Действие6ПередСозданиемЗадач(Перечисления.Согласование2ТочкиМаршрута.Действие4, ФормируемыеЗадачи, Истина);
		КонецЕсли;
