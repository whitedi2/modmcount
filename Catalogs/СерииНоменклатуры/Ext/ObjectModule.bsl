...
Процедура ПередЗаписью(Отказ)
	Наименование = Формат(ДатаПроизводства, "ДФ=yyyy.MM.dd");
	Если Наименование = "" И Номер = "" Тогда
	...
	Иначе
		...
		КонецЕсли;
	КонецЕсли;
	БюджетныйНаСервере.ЗаписатьИзмененныеРеквизитыОбъекта(ЭтотОбъект,Ложь); 
