...
Процедура УУ_ПриСозданииНаСервереПосле(Отказ, СтандартнаяОбработка)
	...
	ГруппаПероваяСтрока.ОтображатьЗаголовок = Ложь;
	
	Группа3Строка = Элементы.Добавить(
	"УпрГруппа3Строка",
	Тип("ГруппаФормы"),
	Группа);
	Группа3Строка.Вид = ВидГруппыФормы.ОбычнаяГруппа;
	Группа3Строка.Поведение  = ПоведениеОбычнойГруппы.Обычное;
	Группа3Строка.Группировка = ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяВсегда;
	Группа3Строка.Отображение = ОтображениеОбычнойГруппы.Нет;
	Группа3Строка.ОтображатьЗаголовок = Ложь;
	...
	ГруппаВтораяСтрокаСтрока.ОтображатьЗаголовок = Ложь;
	...
	ПолеВвода = Элементы.Добавить("упрДлина", Тип("ПолеФормы"), Группа3Строка);
	ПолеВвода.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВвода.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Верх;
	ПолеВвода.ПутьКДанным = "Объект.Длина";
	
	ПолеВвода = Элементы.Добавить("упрШирина", Тип("ПолеФормы"), Группа3Строка);
	ПолеВвода.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВвода.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Верх;
	ПолеВвода.ПутьКДанным = "Объект.Ширина";
	
	ПолеВвода = Элементы.Добавить("упрВысота", Тип("ПолеФормы"), Группа3Строка);
	ПолеВвода.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВвода.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Верх;
	ПолеВвода.ПутьКДанным = "Объект.Высота";  
	
	ПолеВвода = Элементы.Добавить("ГлобальнойКодДанон", Тип("ПолеФормы"), Группа); 
	ПолеВвода.Заголовок = "Глобальной код (Данон)";
	ПолеВвода.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВвода.ПутьКДанным = "Объект.ГлобальнойКодДанон"; 
