...
Процедура ЗаполнитьВидыВнутрДокументов()
	...
	Если Справочники.Д_ВидыВнутреннихДокументов.НайтиПоНаименованию("Заявка на авансовый отчет", Истина) = Неопределено Тогда
		НовыйЭлемент = Справочники.Д_ВидыВнутреннихДокументов.СоздатьГруппу();
	...
	Если Справочники.Д_ВидыВнутреннихДокументов.НайтиПоНаименованию("Заявка на корректировку бюджета", Истина) = Неопределено Тогда
		НовыйЭлемент = Справочники.Д_ВидыВнутреннихДокументов.СоздатьГруппу();
	...
	Если Справочники.Д_ВидыВнутреннихДокументов.НайтиПоНаименованию("Заявка на оплату", Истина) = Неопределено Тогда
		НовыйЭлемент = Справочники.Д_ВидыВнутреннихДокументов.СоздатьГруппу();
	...
	Если Справочники.Д_ВидыВнутреннихДокументов.НайтиПоНаименованию("Заявка на согласование договора", Истина) = Неопределено Тогда
		НовыйЭлемент = Справочники.Д_ВидыВнутреннихДокументов.СоздатьГруппу();
	...
	Если Справочники.Д_ВидыВнутреннихДокументов.НайтиПоНаименованию("Реестр платежей", Истина) = Неопределено Тогда
		НовыйЭлемент = Справочники.Д_ВидыВнутреннихДокументов.СоздатьГруппу();
	...
	Если Справочники.Д_ВидыВнутреннихДокументов.НайтиПоНаименованию("Служебная записка", Истина) = Неопределено Тогда
		НовыйЭлемент = Справочники.Д_ВидыВнутреннихДокументов.СоздатьГруппу();
