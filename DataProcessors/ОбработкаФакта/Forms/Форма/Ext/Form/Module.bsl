		...
		Для Каждого ТекСтрока Из Элементы.Объект3.ВыделенныеСтроки Цикл
			...
			Если ЗначениеЗаполнено(Объект.Подразделение) Тогда
				...
				Если ЗначениеЗаполнено(Объект.ЦФО) Тогда
					СтрокаДляОбработки.ЦФО2 						= Объект.ЦФО; 
				иначе 
					СтрокаДляОбработки.ЦФО2						= ТекСтрока2.ЦФО;
				КонецЕсли;	
			КонецЕсли;
			Если ЗначениеЗаполнено(Объект.КлючАналитики) Тогда
				СтрокаДляОбработки.КлючАналитики 			= Объект.КлючАналитики;
			КонецЕсли;
		...
		Если ТипЗнч(ТекДок) = Тип("ДокументСсылка.УЧ_ДвижениеДС") Тогда
			...
			Для Каждого ТекСтрока Из МассивСтрок Цикл
				...
				Если ЗначениеЗаполнено(ТекСтрока.Подразделение) Тогда
					...
					//КонецЕсли; 
					ТекДокОбъект.Подразделение = ТекСтрока.Подразделение;
					Если ЗначениеЗаполнено(ТекСтрока.ЦФО2) тогда
						ИзменитьЦФО(ТекСтрока.ЦФО2,ТекСтрока.Подразделение); 
					КонецЕсли;
				...
				КонецЕсли;
				Если ЗначениеЗаполнено(ТекСтрока.КлючАналитики) Тогда  
					ТекДокОбъект.Проводки[ТекСтрока.НомерСтроки - 1].КлючАналитикиБюджета = ТекСтрока.КлючАналитики; 	
				КонецЕсли;
