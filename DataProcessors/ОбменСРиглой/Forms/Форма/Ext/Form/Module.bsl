...
Процедура ВыгрузитьПрайсЛист(Команда) 
	...
	ПараметрыФормыПрайса = Новый Структура;
	ПараметрыФормыПрайса.Вставить("ТипЦен",Объект.ПрайсТипЦен);
	ПараметрыФормыПрайса.Вставить("ПутьПрайса",Объект.ПутьПрайсы);
	
	ОткрытьФорму("Обработка.ОбменСРиглой.Форма.Прайс",ПараметрыФормыПрайса,ЭтаФорма,,,,,
