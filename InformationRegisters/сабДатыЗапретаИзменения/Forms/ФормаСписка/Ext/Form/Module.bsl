...
Процедура ДатыЗапретаИзмененияДанных(Команда)
	...
	ОткрытьФорму("РегистрСведений.сабДатыЗапретаИзменения.Форма.ДатыЗапретаИзменения");
...
Процедура УстановитьУсловноеОформление()
	...
	Для каждого ТипПользователя Из Метаданные.РегистрыСведений.сабДатыЗапретаИзменения.Измерения.Пользователь.Тип.Типы() Цикл
