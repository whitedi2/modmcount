...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИндексГруппы = 1;
	ОбщийИндекс = 1;
	Для каждого ТекПодсистема Из Метаданные.Подсистемы.модульУправленка.Подсистемы.сабДокументооборот.Подсистемы.сабДокументооборотСлужебная.Подсистемы.сабГруппировкаВнутреннихДокументовПереопределяемый.Подсистемы Цикл
