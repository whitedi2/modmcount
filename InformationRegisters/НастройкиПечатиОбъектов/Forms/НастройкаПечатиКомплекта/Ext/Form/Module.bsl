...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объекты.Количество() = 1 Тогда
		...
		Если ЕстьОрганизация И ЕстьПартнер Тогда
			Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Параметры.Объекты[0], "Контрагент,Организация");
			Организация = Реквизиты.Организация;
			Партнер = Реквизиты.Контрагент;
...
Процедура СформироватьВариантыСохраненияНастроек()
	...
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СохранитьНастройки", "Видимость", Ложь);
	...
	Если ЕстьОрганизация И Ложь Тогда
	...
	Если ЕстьПартнер И Ложь И
	 (НЕ ЕстьОрганизация ИЛИ Ложь) Тогда
...
Процедура ОбновитьКомандуУдаленияНастроек()
	...
	Если ВариантИспользования > 0 Тогда
		...
		Если Пользователи.ЭтоПолноправныйПользователь() Или
			((ВариантИспользования = 2 ИЛИ (ВариантИспользования = 3 И Ложь))
				И Ложь) Тогда
