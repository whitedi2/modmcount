...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле.Имя = "ВидОбъекта" Тогда
		...
		ТекЗнач = ВыбратьИзСписка(СписокЗначений, , СписокЗначений.НайтиПоЗначению(Элементы.Список.ТекущиеДанные.ВидОбъекта));
	...
	Если ТипЗнч(ВыбранныйОбъект) = Тип("СправочникСсылка.Файлы") Тогда
		...
		Иначе
			...
			ДанныеФайла = РаботаСФайламиСлужебныйВызовСервера.ДанныеФайлаДляОткрытия(ВыбранныйОбъект,
...
Процедура СоздатьФайл(Команда)
	...
	РаботаСФайламиСлужебныйКлиент.ДобавитьФайл(Неопределено, ТекВладелец, ЭтотОбъект,,Истина);
...
Функция ПолучитьВладельца(Владелец)
	...
	Возврат Справочники.ПапкиФайлов.НайтиПоНаименованию("Общие файлы", Истина);	
...
Процедура Отправить(Команда)
	...
	Для каждого ТекСтрока Из Элементы.Список.ВыделенныеСтроки Цикл
		МассивФайлов.Добавить(ТекСтрока.Объект);
	КонецЦикла; 
