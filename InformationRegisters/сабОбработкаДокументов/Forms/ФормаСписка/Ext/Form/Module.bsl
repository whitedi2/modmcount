...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокНеобработанных.Параметры.УстановитьЗначениеПараметра("КонецПериода", Дата('00010101'));
...
Процедура ПоказатьИзменения(Команда)
	...
	Если СтруктураКоличествВерсий.КоличествоИзмененныхВерсий Тогда
	...
	Иначе
		Сообщить("Нет сохраненных версий в истории изменений документа. Такое возможно если в БУ не включено сохранение версий документа или документ загружен через обмен данными.");
	КонецЕсли;
