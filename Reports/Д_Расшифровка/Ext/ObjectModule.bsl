...
Процедура ЗаполнитьТаблицу(ТабДок, ПараметрыОтчета) Экспорт
	...
	Если НЕ ПараметрыОтчета.Сценарий1.НайтиПоЗначению(Справочники.СценарииПланирования.НайтиПоНаименованию("Факт", Истина)) = Неопределено И ПараметрыОтчета.Сценарий1.Количество() > 1 Тогда
