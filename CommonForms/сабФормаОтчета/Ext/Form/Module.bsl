...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Если ИмяОтчета = "Отчет.Д_ФинансовыйРезультат" ИЛИ ИмяОтчета = "ВнешнийОтчет.Д_ФинансовыйРезультат" Тогда
		...
		Иначе                                                                                             
			...
			ПериодИнтервал.ДатаНачала = СтруктураРасшифовки.Период;
			ПериодИнтервал.ДатаОкончания = ДобавитьМесяц(СтруктураРасшифовки.Период, ?(СтруктураРасшифовки.Интервал = "Месяц", 1, ?(СтруктураРасшифовки.Интервал = "Квартал", 3, 12))) - 1;
