...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ФормаПараметры.Вставить("КлючПредопределенногоВарианта", "");
	...
	Если ИмяОтчета = "Отчет.сабОтчетПоУчетномуРегистру" Тогда
	...
	Если Параметры.Свойство("НеОтображатьБыстрыеНастройки") Тогда
		...
		КонецЕсли;
	КонецЕсли;	
	Если ИмяОтчета = "Отчет.сабОтчетПоРезервам" тогда 
		
		Элементы.ОбщаяСтраницаНастроек.РастягиватьПоВертикали = Истина;
		Элементы.ОбщаяСтраницаНастроек.Высота = 15;
		Элементы.КомпоновщикНастроекПользовательскиеНастройки.РастягиватьПоВертикали = Истина;
		Элементы.КомпоновщикНастроекПользовательскиеНастройки.АвтоМаксимальнаяВысота = Ложь;
		Элементы.КомпоновщикНастроекПользовательскиеНастройки.МаксимальнаяВысота = 15;
		Элементы.КомпоновщикНастроекПользовательскиеНастройки.Высота = 15; 
...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
		...
		Для Каждого ЭлементНастроекР Из ОСВ.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы Цикл
			...
			Если ТипЗнч(ЭлементНастроекР) = Тип("ЭлементОтбораКомпоновкиДанных") Тогда // отбор по предприятию в расшифровке
				...
				Иначе
					...
					ЭлементНастроекР.Использование = Ложь;
				КонецЕсли;
	...
	Если ИмяОтчета = "Отчет.УЧ_ВнутрихолдинговыеРасчеты" ИЛИ ИмяОтчета = "ВнешнийОтчет.УЧ_ВнутрихолдинговыеРасчеты" Тогда	
		...
		ОтчетРасшифровка = ПолучитьФорму("Отчет.сабОтчетПоУчетномуРегистру.ФормаОбъекта");		
	...
	// Сводный финансовый результат на СКД
	Если ИмяОтчета = "Отчет.Д_ФинансовыйРезультат" ИЛИ ИмяОтчета = "ВнешнийОтчет.Д_ФинансовыйРезультат" Тогда
		СтандартнаяОбработка = Ложь;
		СтруктураРасшифовки = СтруктураРасшифровкиФинРез(ДанныеРасшифровки, Расшифровка);
		ФормаРасшифровки = ПолучитьФорму("Отчет.сабРасшифровкаФР.Форма");		 			 
		
		Если СтруктураРасшифовки.Период = Неопределено Тогда
			ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[0].Значение      = СтруктураРасшифовки.ПериодОтчета;
		Иначе                                                                                             
			ПериодИнтервал = Новый СтандартныйПериод;
			ПериодИнтервал.ДатаНачала = Макс(СтруктураРасшифовки.Период, СтруктураРасшифовки.ПериодОтчета.ДатаНачала);
			ПериодИнтервал.ДатаОкончания = Мин(ДобавитьМесяц(СтруктураРасшифовки.Период, ?(СтруктураРасшифовки.Интервал = "Месяц", 1, ?(СтруктураРасшифовки.Интервал = "Квартал", 3, 12))) - 1, СтруктураРасшифовки.ПериодОтчета.ДатаОкончания);
			ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[0].Значение = ПериодИнтервал;
		КонецЕсли;
		
		ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[1].Значение = СтруктураРасшифовки.Сценарий;
		ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[2].Значение      = СтруктураРасшифовки.Интервал;
		ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[3].Значение      = СтруктураРасшифовки.СценарийФакт;
		//ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[4].Значение      = СтруктураРасшифовки.ЭквивалентнаяВалюта;
		//ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[5].Значение      = Не СтруктураРасшифовки.ОкруглятьДоЦелого;
		//ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[7].Использование = Истина;
		//ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[7].ВидСравнения  = ВидСравненияКомпоновкиДанных.Равно;
		...
		ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[4].Элементы.Очистить();
		
		Если СтруктураРасшифовки.Отборы.Свойство("ПредприятияРасшифровки") Тогда
			СтандартныеОтчетыКлиентСервер.ДобавитьОтбор(ФормаРасшифровки.Отчет.КомпоновщикНастроек, "Предприятия", СтруктураРасшифовки.Отборы.ПредприятияРасшифровки, ВидСравненияКомпоновкиДанных.ВСписке, Истина, Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ); 
		КонецЕсли;
		
		Если СтруктураРасшифовки.Отборы.Свойство("ПодразделениеРасшифровки") Тогда
			СтандартныеОтчетыКлиентСервер.ДобавитьОтбор(ФормаРасшифровки.Отчет.КомпоновщикНастроек, "Подразделение", СтруктураРасшифовки.Отборы.ПодразделениеРасшифровки, ВидСравненияКомпоновкиДанных.ВСписке, Истина, Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ); 
		КонецЕсли;
		
		Если СтруктураРасшифовки.Отборы.Свойство("Порядок") Тогда
			СтандартныеОтчетыКлиентСервер.ДобавитьОтбор(ФормаРасшифровки.Отчет.КомпоновщикНастроек, "Порядок", СтруктураРасшифовки.Отборы.Порядок, ВидСравненияКомпоновкиДанных.Равно, Истина, Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ); 		
		КонецЕсли; 
		
		//Если СтруктураРасшифовки.Отборы.Свойство("ТипНоменклатуры") Тогда
		//	СтандартныеОтчетыКлиентСервер.ДобавитьОтбор(ФормаРасшифровки.Отчет.КомпоновщикНастроек, "ТипНоменклатуры", СтруктураРасшифовки.Отборы.ТипНоменклатуры, ВидСравненияКомпоновкиДанных.ВСписке, Истина, Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ); 		
		//КонецЕсли;   
		
		Если СтруктураРасшифовки.Отборы.Свойство("НоменклатурнаяГруппа") Тогда
			СтандартныеОтчетыКлиентСервер.ДобавитьОтбор(ФормаРасшифровки.Отчет.КомпоновщикНастроек, "Номенклатура.НоменклатурнаяГруппа", СтруктураРасшифовки.Отборы.НоменклатурнаяГруппа, ВидСравненияКомпоновкиДанных.ВСписке, Истина, Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ); 		
		КонецЕсли; 
		
		Если СтруктураРасшифовки.Отборы.Свойство("Номенклатура") Тогда
			СтандартныеОтчетыКлиентСервер.ДобавитьОтбор(ФормаРасшифровки.Отчет.КомпоновщикНастроек, "Номенклатура", СтруктураРасшифовки.Отборы.Номенклатура, ВидСравненияКомпоновкиДанных.ВСписке, Истина, Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ); 		
		КонецЕсли;    
		
		Если СтруктураРасшифовки.Отборы.Свойство("Статья") Тогда
			СтандартныеОтчетыКлиентСервер.ДобавитьОтбор(ФормаРасшифровки.Отчет.КомпоновщикНастроек, "Статья", СтруктураРасшифовки.Отборы.Статья, ВидСравненияКомпоновкиДанных.Равно, Истина, Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ); 		
		КонецЕсли;   
		
		Если СтруктураРасшифовки.Отборы.Свойство("СтатьяЗатрат") Тогда
			СтандартныеОтчетыКлиентСервер.ДобавитьОтбор(ФормаРасшифровки.Отчет.КомпоновщикНастроек, "СтатьяЗатрат", СтруктураРасшифовки.Отборы.СтатьяЗатрат, ВидСравненияКомпоновкиДанных.Равно, Истина, Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ); 		
		КонецЕсли;
		
		Если СтруктураРасшифовки.Отборы.Свойство("Статья25Счета") Тогда
			СтандартныеОтчетыКлиентСервер.ДобавитьОтбор(ФормаРасшифровки.Отчет.КомпоновщикНастроек, "Статья25Счета", СтруктураРасшифовки.Отборы.Статья25Счета, ВидСравненияКомпоновкиДанных.Равно, Истина, Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ); 		
		КонецЕсли;
...
Процедура ПредприятияПометкаПриИзменении(Элемент)
	...
	Для каждого ТекЭл1 Из Предприятия.ПолучитьЭлементы() Цикл
		Если ТекЭл1.Пометка Тогда
			МассивПредприятий.Добавить(ТекЭл1.Значение);
		КонецЕсли;
...
Функция ПараметрыРасшифровкиПлана(Расшифровка, РезультатОтчет, План, ИмяОтчета)
		...
		Если ТипЗнч(Строка) <> Тип("ЭлементРасшифровкиКомпоновкиДанныхГруппировка")Тогда
			...
			Если ТипЗнч(Строка.ПолучитьПоля()[0].Значение) = Тип("СправочникСсылка.СтатьиДвиженияДенежныхСредств") Тогда
				...
				Иначе
					Статья = Строка.ПолучитьПоля()[0].Значение;
				КонецЕсли;
			ИначеЕсли ТипЗнч(Строка.ПолучитьПоля()[0].Значение) = Тип("СправочникСсылка.КлючиАналитикиБюджетов") ИЛИ ТипЗнч(Строка.ПолучитьПоля()[0].Значение) = Тип("СправочникСсылка.Проекты")  Тогда
				
				Если Не АналитикаБюджета = Неопределено Тогда
					
					Если АналитикаБюджета.Уровень() < Строка.ПолучитьПоля()[0].Значение.Уровень() Тогда
						АналитикаБюджета = Строка.ПолучитьПоля()[0].Значение;
					КонецЕсли;
	...
	СтруктураВозврата.Вставить("Статья", Статья);
	СтруктураВозврата.Вставить("АналитикаБюджета", АналитикаБюджета);
...
&НаСервере
Функция СтруктураРасшифровкиФинРез(ДанныеРасшифровки, Расшифровка)
	
	ДР = ПолучитьИзВременногоХранилища(ДанныеРасшифровки);
	Эл = ДР.Элементы.Получить(Расшифровка);	  
	
	Статья = ПолучитьСтатьюБаланса(ДР.Элементы.Получить(Расшифровка), "Статья"); 
	Статья25Счета = ПолучитьСтатьюБаланса(ДР.Элементы.Получить(Расшифровка), "Статья25счета"); 
	СтатьяЗатрат = ПолучитьСтатьюБаланса(ДР.Элементы.Получить(Расшифровка), "СтатьяЗатрат");
	НоменклатурнаяГруппа = ПолучитьСтатьюБаланса(ДР.Элементы.Получить(Расшифровка), "Номенклатура.НоменклатурнаяГруппа");
	Номенклатура = ПолучитьСтатьюБаланса(ДР.Элементы.Получить(Расшифровка), "Номенклатура");
	ТипНоменклатуры = ПолучитьСтатьюБаланса(ДР.Элементы.Получить(Расшифровка), "ТипНоменклатуры");
	Порядок = ПолучитьСтатьюБаланса(ДР.Элементы.Получить(Расшифровка), "Порядок");
	ПредприятияРасшифровки = ПолучитьСтатьюБаланса(ДР.Элементы.Получить(Расшифровка), "Предприятия");
	ПодразделениеРасшифровки = ПолучитьСтатьюБаланса(ДР.Элементы.Получить(Расшифровка), "Подразделение");
	
	СтруктураОтборов = Новый Структура;
	
	Если Статья <> Неопределено Тогда
		СтруктураОтборов.Вставить("Статья", Статья);
	КонецЕсли;   
	
	Если СтатьяЗатрат <> Неопределено Тогда
		СтруктураОтборов.Вставить("СтатьяЗатрат", СтатьяЗатрат);
	КонецЕсли; 
	
	Если Статья25Счета <> Неопределено Тогда
		СтруктураОтборов.Вставить("Статья25Счета", Статья25Счета);
	КонецЕсли;
	
	Если НоменклатурнаяГруппа <> Неопределено Тогда
		СтруктураОтборов.Вставить("НоменклатурнаяГруппа", НоменклатурнаяГруппа);
	КонецЕсли;
	...
	Если ТипНоменклатуры <> Неопределено Тогда
		СтруктураОтборов.Вставить("ТипНоменклатуры", ТипНоменклатуры);
	КонецЕсли;

	Если Порядок <> Неопределено Тогда
		СтруктураОтборов.Вставить("Порядок", Порядок);
	ИначеЕсли Номенклатура <> Неопределено Или ТипНоменклатуры <> Неопределено Тогда
		СтруктураОтборов.Вставить("Порядок", "Реализация");
	КонецЕсли;

	Если ПредприятияРасшифровки <> Неопределено Тогда
		СтруктураОтборов.Вставить("ПредприятияРасшифровки", ПредприятияРасшифровки);
	КонецЕсли;
	
	Если ПодразделениеРасшифровки <> Неопределено Тогда
		СтруктураОтборов.Вставить("ПодразделениеРасшифровки", ПодразделениеРасшифровки);
	КонецЕсли;
	...
	Попытка 
		СтруктураВозврата.Вставить("Период", Эл.ПолучитьРодителей()[1].ПолучитьПоля()[0].Значение);
	Исключение
		СтруктураВозврата.Вставить("Период", Неопределено);
	КонецПопытки;
		
	СтруктураВозврата.Вставить("Отборы", СтруктураОтборов);
	...
	Попытка  
		...
		Если СтрНайти(НРег(ДР.Элементы.Получить(Расшифровка).ПолучитьПоля()[0].Поле), "факт") <> 0 Тогда
			СтруктураВозврата.Вставить("Сценарий", ПользНастройки.Элементы[1].Значение);
		Иначе
			СтруктураВозврата.Вставить("Сценарий", ПользНастройки.Элементы[0].Значение);
		КонецЕсли;
	...
	СтруктураВозврата.Вставить("ПериодОтчета", ПользНастройки.Элементы[2].Значение);
	СтруктураВозврата.Вставить("ЭквивалентнаяВалюта", ПользНастройки.Элементы[4].Значение);
	СтруктураВозврата.Вставить("Интервал", ПользНастройки.Элементы[3].Значение);
	СтруктураВозврата.Вставить("ОкруглятьДоЦелого", ПользНастройки.Элементы[5].Значение);
	СтруктураВозврата.Вставить("СценарийФакт", Справочники.СценарииПланирования.НайтиПоНаименованию("Факт", Истина));
...
Процедура ПерейтиКНастройкамДляТехническогоСпециалиста(Команда)
	...
	ОткрытьФормуНастроекДляТехническогоСпециалиста("СтраницаСтруктураВарианта");
...
Процедура ОткрытьФормуНастроекДляТехническогоСпециалиста(ИмяСтраницы, ОбработчикЗавершения = Неопределено)
	...
	ПараметрыФормы.Вставить("ВариантНаименование", Строка(КлючТекущегоВарианта));
	...
	ПараметрыФормы.Вставить("ПредставлениеВарианта", НаименованиеТекущегоВарианта);
	...
	ПараметрыФормы.Вставить("ПользовательскиеНастройкиМодифицированы",
		ВариантМодифицирован Или ПользовательскиеНастройкиМодифицированы);
	...
	ОткрытьФорму(ИмяОтчета() + ".ФормаВарианта", ПараметрыФормы, ЭтаФорма, , , , ОбработчикЗавершения, РежимОкна);
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	Если ТипЗнч(ВыбранноеЗначение) = Тип("Структура") И ВыбранноеЗначение.Свойство("КомпоновщикНастроекКД") Тогда
		ОбновитьЭлементыФормыНастроек(ВыбранноеЗначение);
	КонецЕсли;
КонецПроцедуры

&НаСервере
Процедура ОбновитьЭлементыФормыНастроек(ВыбранноеЗначение)
	Настройки = ВыбранноеЗначение.КомпоновщикНастроекКД.Настройки;
	ПользовательскиеНастройки = ВыбранноеЗначение.КомпоновщикНастроекКД.ПользовательскиеНастройки;
	
	//фильтруем параметры отчета
	Для Каждого ЭлементСтруктуры Из Настройки.ПараметрыДанных.Элементы Цикл
		Если Не ЭлементСтруктуры.Использование Тогда
			Продолжить;		
		КонецЕсли;
		СтандартныеОтчетыКлиентСервер.УстановитьПараметр(Отчет.КомпоновщикНастроек.ПользовательскиеНастройки, ЭлементСтруктуры.Параметр, ЭлементСтруктуры.Значение, ЭлементСтруктуры.Использование); 
	КонецЦикла;
	
	Отчет.КомпоновщикНастроек.ЗагрузитьНастройки(Настройки);
	
	//Поиск элемента пользовательских настроек по уникальному идентификатору раздела настроек 
	ОтборПользовательскиеНастройки = Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы.Найти(Отчет.КомпоновщикНастроек.Настройки.Отбор.ИдентификаторПользовательскойНастройки);
	
	Если ОтборПользовательскиеНастройки = Неопределено Тогда
		Возврат;	
	КонецЕсли;
	
	Для Каждого ЭлементСтруктуры Из Настройки.Отбор.Элементы Цикл
		...
		Для каждого ЭлементОтбора Из ОтборПользовательскиеНастройки.Элементы Цикл
			Если ТипЗнч(ЭлементОтбора) = Тип("ЭлементОтбораКомпоновкиДанных")
				и ЭлементОтбора.ЛевоеЗначение = ЭлементСтруктуры.ЛевоеЗначение Тогда
		...
		Если ОтборПоСкладу = Неопределено Тогда
			...
			ОтборПоСкладу.ЛевоеЗначение = ЭлементСтруктуры.ЛевоеЗначение;
		...
		ОтборПоСкладу.Использование = ЭлементСтруктуры.Использование;
		ОтборПоСкладу.ВидСравнения = ЭлементСтруктуры.ВидСравнения;
		ОтборПоСкладу.ПравоеЗначение = ЭлементСтруктуры.ПравоеЗначение;	
		
		//СтандартныеОтчетыКлиентСервер.ДобавитьОтбор(Отчет.КомпоновщикНастроек.ПользовательскиеНастройки, ЭлементСтруктуры.ЛевоеЗначение, ЭлементСтруктуры.ПравоеЗначение, ЭлементСтруктуры.ВидСравнения, ЭлементСтруктуры.Использование, Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ); 
	КонецЦикла;
	
	//очищаем лишние елементы отбора
	МассивЛишнихЭлементовОтбора = Новый Массив;
	Для Каждого ЭлементСтруктуры Из ОтборПользовательскиеНастройки.Элементы Цикл
		...
		Если ОтборПоСкладу = Неопределено Тогда
			МассивЛишнихЭлементовОтбора.Добавить(ЭлементСтруктуры);
		КонецЕсли;
		
	КонецЦикла;
	
	Для каждого ТекЭлементКУдалению Из МассивЛишнихЭлементовОтбора Цикл
		ОтборПользовательскиеНастройки.Элементы.Удалить(ТекЭлементКУдалению);		
	КонецЦикла;
