...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Если ИмяОтчета = "Отчет.Д_ФинансовыйРезультат" ИЛИ ИмяОтчета = "ВнешнийОтчет.Д_ФинансовыйРезультат" Тогда
		...
		Если СтруктураРасшифовки.Сценарий2Использование Тогда 
			ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[1].Значение      = СтруктураРасшифовки.Сценарий2;
		Иначе
			ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[1].Значение      = ПредопределенноеЗначение("Справочник.СценарииПланирования.ПустаяСсылка");
		КонецЕсли;	 
		...
		Иначе                                                                                             
			...
			ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[2].Значение = ПериодИнтервал;
		КонецЕсли;
		...
		ФормаРасшифровки.Отчет.КомпоновщикНастроек.ПользовательскиеНастройки.Элементы[5].Элементы.Очистить();
		...
		Если СтруктураРасшифовки.Отборы.Свойство("СтатьяЗатрат") Тогда
			СтандартныеОтчетыКлиентСервер.ДобавитьОтбор(ФормаРасшифровки.Отчет.КомпоновщикНастроек, "СтатьяЗатрат", СтруктураРасшифовки.Отборы.СтатьяЗатрат, ВидСравненияКомпоновкиДанных.ВИерархии, Истина, Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.БыстрыйДоступ); 		
		КонецЕсли; 
