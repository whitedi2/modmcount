...
//&НаСервере
//Функция ПолучитьЗначенияПолейРасшифровки(Эл, СтруктураПолей)
//		
//	Если Эл.ПолучитьПоля().Количество() Тогда
//		
//		Если СтруктураПолей.Свойство(Эл.ПолучитьПоля()[0].Поле) Тогда
//			СтруктураПолей[Эл.ПолучитьПоля()[0].Поле] = Эл.ПолучитьПоля()[0].Значение;
//		Иначе
//			ТекСтатья = ПолучитьЗначенияПолейРасшифровкиВИерархии(Эл, СтруктураПолей)
//		КонецЕсли;  
//		
//	КонецЕсли;
//		
...
//&НаСервереБезКонтекста
//Функция ПолучитьЗначенияПолейРасшифровкиВИерархии(ТекЭлРасшифровки, СтруктураПолей)
//		
//	Попытка 		
//		
//		Пока Не СтруктураПолей.Свойство(ТекЭлРасшифровки.ПолучитьПоля()[0].Поле) Цикл 
//			МассивРодителей = ТекЭлРасшифровки.ПолучитьРодителей();
//			
//			Если МассивРодителей.Количество() Тогда
//				ТекЭлРасшифровки = МассивРодителей[0];
...
//		КонецЦикла;
//		
//		СтруктураПолей[Эл.ПолучитьПоля()[0].Поле] = ТекЭлРасшифровки.ПолучитьПоля()[0].Значение;
//	Исключение
//		МассивРодителей = ТекЭлРасшифровки.ПолучитьРодителей();
//		
//		Если МассивРодителей.Количество() Тогда
//			СтруктураПолей[Эл.ПолучитьПоля()[0].Поле] = ПолучитьСтатьюВИерархии(МассивРодителей[0], СтруктураПолей)
//		КонецЕсли;
//		
//	КонецПопытки;
//	
