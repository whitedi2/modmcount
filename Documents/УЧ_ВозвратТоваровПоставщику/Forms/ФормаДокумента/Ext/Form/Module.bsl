...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если сабОбщегоНазначенияПовтИсп.ПолучитьСерийныйУчет() Тогда  
		сабОперОбщегоНазначения.ОчиститьСериюВОсновнойТЧДляНесколькихСерий(Объект.Товары,ТекущийОбъект.Товары);
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	//	сабОперОбщегоНазначения.ОчиститьСериюВОсновнойТЧДляНесколькихСерий(Объект.Товары);
	//КонецЕсли;
