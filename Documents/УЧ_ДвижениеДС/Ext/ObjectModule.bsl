...
Процедура ПриЗаписи(Отказ)
	...
	Если Проведен Тогда
		Если ТипЗнч(ДокОснование) = Тип("ДокументСсылка.ПлатежноеПоручение") И ЗначениеЗаполнено(ДокОснование.Заявка) И ТипЗнч(ДокОснование.Заявка) = Тип("ДокументСсылка.СчетНаОплатуПокупателю") Тогда
			НаборЗаписей = РегистрыСведений.сабГрафикПлатежей.СоздатьНаборЗаписей();
			НаборЗаписей.Отбор.Документ.Установить(ДокОснование.Заявка);
			НаборЗаписей.Прочитать();
