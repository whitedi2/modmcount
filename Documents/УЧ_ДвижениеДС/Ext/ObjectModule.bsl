...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Если Проводки.Количество() Тогда
		...
		Если  Проводки.Количество() = 1 И ТипЗнч(Проводки[0].КорСубконто3) = Тип("ДокументСсылка.УЧ_ВыплатаЗП") И ЗначениеЗаполнено(Проводки[0].КорСубконто3) И ТипЗнч(Проводки[0].КорСубконто1) = Тип("СправочникСсылка.Сотрудники") И Проводки[0].КорСубконто1.Предопределенный
			ИЛИ ТипЗнч(Проводки[0].КорСубконто3) = Тип("ДокументСсылка.УЧ_ВыплатаЗП") И ЗначениеЗаполнено(Проводки[0].КорСубконто3) И (ТипЗнч(Проводки[0].КорСубконто1) = Тип("СправочникСсылка.Сотрудники") ИЛИ ТипЗнч(Проводки[0].КорСубконто1) = Тип("СправочникСсылка.ФизическиеЛица") ИЛИ ТипЗнч(Проводки[0].КорСубконто1) = Тип("СправочникСсылка.Контрагенты")) И Проводки[0].КорСубконто3.СуммаДокумента = ЭтотОбъект.СуммаДокумента Тогда
