...
Процедура УУ_ПриСозданииНаСервереПосле(Отказ, СтандартнаяОбработка)
	...
	ПолеВводаСНО = Элементы.Добавить("ДокументОснование", Тип("ПолеФормы")); 
	ПолеВводаСНО.Заголовок = "Счет на оплату";
	ПолеВводаСНО.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВводаСНО.ПутьКДанным = "Объект.ДокументОснование";
	
	МассивТипов = Новый Массив;
	МассивТипов.Добавить(Тип("ДокументСсылка.СчетНаОплатуПоставщика"));
	ОписаниеТиповСНО = Новый ОписаниеТипов(МассивТипов);

	ПолеВводаСНО.ОграничениеТипа = ОписаниеТиповСНО;
	ПолеВводаСНО.УстановитьДействие("ПриИзменении", "ДокументОснованиеПриИзменении"); 
               
...
Процедура ДокументОснованиеПриИзмененииСервер()	
	...
	ТекДокОбъект = РеквизитФормыВЗначение("Объект"); 
	ТекДокОбъект.Заполнить(Объект.ДокументОснование);
	//ЗаполнениеДокументов.Заполнить(ТекДокОбъект, Объект.ДокументОснование);  
	ЗначениеВРеквизитФормы(ТекДокОбъект, "Объект");
