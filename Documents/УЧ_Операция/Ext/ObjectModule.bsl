...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ПересчитыватьЦенуСписанияВПроводках Тогда
		...
		Для Каждого ТекСтрокаТабличнаяЧасть Из Проводки Цикл
			...
			Если Не ТекСтрокаТабличнаяЧасть.СчетКредит.Количественный ИЛИ (Не ТекСтрокаТабличнаяЧасть.Количество И НЕ ТекСтрокаТабличнаяЧасть.СчетКредит.СчетУчетаНоменклатуры) Тогда
				Продолжить;			
			КонецЕсли;
