					...
					Если ВыводитьУпаковки Тогда
						...
						Иначе 
							...
							Если ВыборкаСерии.КоличествоУпаковок = 0 ИЛИ ВыборкаСерии.КоличествоВУпаковке = 0 
								...
								КоличествоУпСбор = 0;
							иначе
								КоличествоУпСбор = Цел(СписатьКоличество / ВыборкаСерии.КоличествоВУпаковке);
								КолВУпак = КоличествоУпСбор * ВыборкаСерии.КоличествоВУпаковке;
					...
					ОбластьСтрокаСуммы.Параметры.Сумма = СписатьСумма; 
						...
						Иначе
							...
							Если ВыборкаСерии.КоличествоУпаковок = 0 ИЛИ ВыборкаСерии.КоличествоВУпаковке = 0 
								...
								КоличествоУпСбор = 0;
							иначе
								КоличествоУпСбор = Цел(ОсталосьСписатьКоличество / ВыборкаСерии.КоличествоВУпаковке);
								КолВУпак = КоличествоУпСбор * ВыборкаСерии.КоличествоВУпаковке;
