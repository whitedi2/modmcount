...
Процедура УУ_ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	//		Запрос.Текст = 
	//		//"ВЫБРАТЬ
	//		//|	ПоступлениеТоваровУслугТовары.НомерСтроки КАК НомерСтрокиРеализации,
	//		//|	ПоступлениеТоваровУслугТовары.Номенклатура КАК Номенклатура,
	//		//|	ЕСТЬNULL(ПоступлениеТоваровУслугСерииНоменклатуры.Количество, 0) КАК Количество,
	//		//|	ЕСТЬNULL(ПоступлениеТоваровУслугСерииНоменклатуры.СерияНоменклатуры, ЗНАЧЕНИЕ(Справочник.СерииНоменклатуры.ПустаяСсылка)) КАК СерияНоменклатуры,
	//		//|	ЕСТЬNULL(ПоступлениеТоваровУслугСерииНоменклатуры.СерияНоменклатуры.ДатаПроизводства, ДАТАВРЕМЯ(1, 1, 1)) КАК ДатаПроизводства
	//		//|ИЗ
	//		//|	Документ.ПоступлениеТоваровУслуг.Товары КАК ПоступлениеТоваровУслугТовары
	//		//|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.ПоступлениеТоваровУслуг.СерииНоменклатуры КАК ПоступлениеТоваровУслугСерииНоменклатуры
	//		//|		ПО ПоступлениеТоваровУслугТовары.Номенклатура = ПоступлениеТоваровУслугСерииНоменклатуры.Номенклатура
	//		//|			И ПоступлениеТоваровУслугТовары.НомерСтроки = ПоступлениеТоваровУслугСерииНоменклатуры.НомерСтрокиРеализации
	//		//|ГДЕ
	//		//|	ПоступлениеТоваровУслугСерииНоменклатуры.Ссылка = &Ссылка
