...
Процедура ТоварыСуммаПриИзменении(Элемент)
	...
	СтавкаНДС = ПолучитьСтавкуНДСНаСервере(ТД.СтавкаНДС);
	ТД.СуммаНДС = УчетНДСКлиентСервер.РассчитатьСуммуНДС(ТД.Сумма,Объект.ЦенаВключаетНДС,СтавкаНДС);
...
&НаСервереБезКонтекста
Функция ПолучитьСтавкуНДСНаСервере(СтавкаНДС)
