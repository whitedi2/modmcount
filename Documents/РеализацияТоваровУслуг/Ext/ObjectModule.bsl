...
Процедура УУ_ПередЗаписью1(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если Модифицированность() Тогда
		...
		КонецЕсли;
	КонецЕсли;
	ЭтоСинхронизацияСерийПриПроведенииУпрДокумента = Ложь;
	Если ДополнительныеСвойства.Свойство("ЭтоСинхронизацияСерийПриПроведенииУпрДокумента") Тогда
		Если ДополнительныеСвойства.ЭтоСинхронизацияСерийПриПроведенииУпрДокумента Тогда
			ЭтоСинхронизацияСерийПриПроведенииУпрДокумента = Истина;	
		КонецЕсли;
	КонецЕсли;
	Если НЕ ЭтоНовый() Тогда
		Если (ОбменДанными.Загрузка Или ЭтотОбъект.ДополнительныеСвойства.Свойство("ЭтоОбмен")) И АвтообновленияЗаблокированы Тогда
			...
			Если Не ИгнорироватьБлокАвтообновления Тогда
				Если Не ЭтоСинхронизацияСерийПриПроведенииУпрДокумента Тогда
