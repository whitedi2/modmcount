...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Для Каждого ТекСтрокаТабличнаяЧасть Из ТабличнаяЧасть Цикл
		...
		Если ЗначениеЗаполнено(ТекСтрокаТабличнаяЧасть.СчетУчета) Тогда
			Если УчетПоподразделениямСчетУчета Тогда
				СтруктураПоиска = Новый Структура("Номенклатура, Склад, Счет, Подразделение, СерияНоменклатуры", ТекСтрокаТабличнаяЧасть.Номенклатура, ?(ЗначениеЗаполнено(Склад), Склад, ТекСтрокаТабличнаяЧасть.Склад), СоответствиеСчета.Получить(ТекСтрокаТабличнаяЧасть.Номенклатура), Подразделение, ТекСтрокаТабличнаяЧасть.СерияНоменклатуры);
			Иначе	
				СтруктураПоиска = Новый Структура("Номенклатура, Склад, Счет, СерияНоменклатуры", ТекСтрокаТабличнаяЧасть.Номенклатура, ?(ЗначениеЗаполнено(Склад), Склад, ТекСтрокаТабличнаяЧасть.Склад), СоответствиеСчета.Получить(ТекСтрокаТабличнаяЧасть.Номенклатура), ТекСтрокаТабличнаяЧасть.СерияНоменклатуры);
			КонецЕсли;
		Иначе	
			Если УчетПоподразделениямСчетУчета Тогда
				СтруктураПоиска = Новый Структура("Номенклатура, Склад, Подразделение, СерияНоменклатуры", ТекСтрокаТабличнаяЧасть.Номенклатура, ?(ЗначениеЗаполнено(Склад), Склад, ТекСтрокаТабличнаяЧасть.Склад), Подразделение, ТекСтрокаТабличнаяЧасть.СерияНоменклатуры);
			Иначе	
				СтруктураПоиска = Новый Структура("Номенклатура, Склад, СерияНоменклатуры", ТекСтрокаТабличнаяЧасть.Номенклатура, ?(ЗначениеЗаполнено(Склад), Склад, ТекСтрокаТабличнаяЧасть.Склад), ТекСтрокаТабличнаяЧасть.СерияНоменклатуры);
			КонецЕсли;
		КонецЕсли;
