...
Процедура ПечатьМаршрутныйЛистНовый(ТабличныйДокумент, МассивОбъектов, ИмяКоманды = Неопределено) Экспорт
	...
	//|////////////////////////////////////////////////////////////////////////////////
	"ВЫБРАТЬ
	|	сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента КАК ВложенныйМЛ,
	|	сабМаршрутныйЛистТабличнаяЧасть.НомерСтроки КАК ПорядокВложенногоМЛ,
	|	сабМаршрутныйЛистТабличнаяЧасть.Ссылка КАК ОсновноМЛ
	|ПОМЕСТИТЬ ВТ_ВложенныеМЛ
	|ИЗ
	|	Документ.сабМаршрутныйЛист.ТабличнаяЧасть КАК сабМаршрутныйЛистТабличнаяЧасть
	|ГДЕ
	|	сабМаршрутныйЛистТабличнаяЧасть.Ссылка В(&МассивОбъектов)
	...
	|ВЫБРАТЬ
	|	НАЧАЛОПЕРИОДА(ВЫБОР
	|			КОГДА ЕСТЬNULL(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ТранзитныйГруз, ЛОЖЬ)
	|				ТОГДА сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ДатаТранзитнойОтгрузки
	|			ИНАЧЕ сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ДатаПоступления
	|		КОНЕЦ, ДЕНЬ) КАК ДатаОтгрузки,
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ТранзитныйГруз, ЛОЖЬ)
	|			ТОГДА сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ДатаТранзитнойОтгрузки
	|		ИНАЧЕ сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ДатаДоставки
	|	КОНЕЦ КАК ДатаДоставки,
	|	ВЫБОР
	|		КОГДА ЕСТЬNULL(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ТранзитныйГруз, ЛОЖЬ)
	|			ТОГДА сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ДатаТранзитнойОтгрузки
	|		ИНАЧЕ сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ДатаДоставкиДо
	|	КОНЕЦ КАК ДатаДоставкиДо,
	|	ВЫБОР
	...
	|	сабМаршрутныйЛистТабличнаяЧасть.НомерСтроки * 1000 КАК ПорядокДоставки
	|ПОМЕСТИТЬ ВТ_Заказ
	|ИЗ
	|	Документ.сабМаршрутныйЛист.ТабличнаяЧасть КАК сабМаршрутныйЛистТабличнаяЧасть
	|ГДЕ
	...
	|		ИНАЧЕ сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.АдресДоставки
	|	КОНЕЦ,
	|	сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.Телефон,
	|	ВЫРАЗИТЬ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ЗаданиеВодителю КАК СТРОКА(1000)),
	|	сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.МенеджерКонтрагента,
	|	сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента,
	|	сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.Дата,
	|	ВТ_ВложенныеМЛ.ОсновноМЛ,
	|	сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ПодразделениеКонтрагента.Примечание,
	|	сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ПодразделениеКонтрагента.КодУпорядочивания,
	|	ВЫРАЗИТЬ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ЗаданиеСкладу КАК СТРОКА(1000)),
	|	ВТ_ВложенныеМЛ.ПорядокВложенногоМЛ * 1000 + сабМаршрутныйЛистТабличнаяЧасть.НомерСтроки
	|ИЗ
	|	Документ.сабМаршрутныйЛист.ТабличнаяЧасть КАК сабМаршрутныйЛистТабличнаяЧасть
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТ_ВложенныеМЛ КАК ВТ_ВложенныеМЛ
	|		ПО сабМаршрутныйЛистТабличнаяЧасть.Ссылка = ВТ_ВложенныеМЛ.ВложенныйМЛ
	|ГДЕ
	|	ТИПЗНАЧЕНИЯ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента) <> ТИП(Документ.сабМаршрутныйЛист)
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	Пока ВыборкаМаршрутныйЛист.Следующий() Цикл
		...
		МаршрутныйЛистПар = ВыборкаМаршрутныйЛист.МаршрутныйЛист; 
		...
		Пока ВыборкаДатаОтгрузки.Следующий() Цикл   
			...
			ОбластьМакета.Параметры.МаршрутДоставки = ПолучитьМаршрутДоставки(МаршрутныйЛистПар);
			ТабличныйДокумент.Вывести(ОбластьМакета);
...
Процедура ПечатьМаршрутныйЛистНовыйФакт1(ТабличныйДокумент, МассивОбъектов, ЗапросМЛ)
	...
	ЗапросМЛ = ПолучитьЗапросМЛ(МассивОбъектов);
	...
	Пока ВыборкаМаршрутныйЛист.Следующий() Цикл 
		...
		Пока ВыборкаДатаОтгрузки.Следующий() Цикл
			...
			ДатаОтгрузкиПар = ВыборкаДатаОтгрузки.ДатаОтгрузки;
			МаршрутДоставкиПар = ПолучитьМаршрутДоставки(МаршрутныйЛистПар);
			КомментарийПар = ВыборкаДатаОтгрузки.Комментарий;
			...
			Пока ВыборкаДатаДоставки.Следующий() Цикл
				...
				Пока ВыборкаДатаДоставкиПо.Следующий() Цикл
					...
					Пока ВыборкаКонтрагент.Следующий() Цикл
						...
						Если НЕ ЗначениеЗаполнено(ВыборкаКонтрагент.Контрагент) тогда
							ОбластьМакета.Параметры.Контрагент = "Кросс-докинг: ";  	
						КонецЕсли;
						...
						Пока ВыборкаАдрес.Следующий() Цикл
							...
							Пока ВыборкаЗаказКлиента.Следующий() Цикл
								...
								Пока ВыборкаНоменклатура.Следующий() Цикл
									...
									КоличествоШтДляСводаСбор = 0; 
									ВесДляСводаСбор = 0;   
									Если ТипЗнч(ВыборкаНоменклатура.ЗаказКлиента) = Тип("ДокументСсылка.сабМаршрутныйЛист") тогда
										КроссДокинг = Истина;
										ТабличныйДокумент.Вывести(ОбластьМакета, 3);
									иначе
			...
			ВесИтог = ВесИтог + ВыборкаДатаОтгрузки.Вес;
		КонецЦикла; 

		ОбластьМакета = Макет.ПолучитьОбласть("Итог");
		ОбластьМакета.Параметры.Вес = ВесИтог;
		ТабличныйДокумент.Вывести(ОбластьМакета);  
		ТабличныйДокумент.ЗакончитьАвтогруппировкуСтрок();
		...
		ТабличныйДокумент.ВывестиГоризонтальныйРазделительСтраниц();
		ОбластьВозвратыИВычерки = Макет.ПолучитьОбласть("ВозвратыИВычерки");
		ОбластьВозвратыИВычерки.Параметры.Доставщик = ВыборкаМаршрутныйЛист.МаршрутныйЛист.Доставщик;
		ОбластьВозвратыИВычерки.Параметры.ПредставлениеДокумента = "Маршрутный лист №";	
		ОбластьВозвратыИВычерки.Параметры.НомерМарштурногоЛиста = ВыборкаМаршрутныйЛист.МаршрутныйЛист.Номер;
		ОбластьВозвратыИВычерки.Параметры.ДатаМаршрутногоЛиста = ВыборкаМаршрутныйЛист.МаршрутныйЛист.Дата;          
		ОбластьВозвратыИВычерки.Параметры.ДатаОтгрузки = Формат(ДатаОтгрузкиПар,"ДФ=dd.MM.yyyy");
		ОбластьВозвратыИВычерки.Параметры.МаршрутДоставки = МаршрутДоставкиПар;
		ОбластьВозвратыИВычерки.Параметры.Комментарий = КомментарийПар;
		ТабличныйДокумент.Вывести(ОбластьВозвратыИВычерки);
	КонецЦикла;
		...
		Если ВыборкаМаршрутныйЛист.ХранитсяПриОтрицательнойТемпературе Тогда
			...
			Пока ВыборкаДатаОтгрузки.Следующий() Цикл
				...
				Если ВыборкаДатаОтгрузки.ХранитсяПриОтрицательнойТемпературе Тогда
					...
					РеквизитыШапки = ПолучитьРеквизитыШапки(ВыборкаМаршрутныйЛист.МаршрутныйЛист);
...
Функция КалькуляцияИМаржаМаршрутногоЛиста(Ссылка) Экспорт
	...
	Для каждого МаршрутныйЛист из ДЗ.Строки Цикл
		...
		Запрос = Новый Запрос;
		#Область ИсходныйЗапросБезОтборов
		//Запрос.Текст = "ВЫБРАТЬ
		//|	ВЫБОР
		...
		|		ПоследниеДокументыНоменклатуры.Номенклатура КАК Номенклатура,
		//Скорр lud 26/04/23 по обр. № 1637 от 25.04.23 Цены без НДС
		|      		ВЫБОР КОГДА ПоследниеДокументыНоменклатуры.Ссылка.СуммаВключаетНДС
		|			ТОГДА ВЫБОР
		|					КОГДА ПоследниеДокументыНоменклатуры.Количество > 0
		|						ТОГДА (ПоследниеДокументыНоменклатуры.Сумма - ПоследниеДокументыНоменклатуры.СуммаНДС) / ПоследниеДокументыНоменклатуры.Количество
		|					ИНАЧЕ 0
		...
		|		ПО ПоследниеДокументыНоменклатуры.Номенклатура = ДатыПоследнихДокументовНоменклатуры.Номенклатура
		|			И ПоследниеДокументыНоменклатуры.Ссылка.Дата = ДатыПоследнихДокументовНоменклатуры.ДатаПоследнегоДокумента
		|			И (ПоследниеДокументыНоменклатуры.Ссылка.Проведен)
		|			И (ПоследниеДокументыНоменклатуры.Ссылка.Организация = &Организация)
		|	ГДЕ
		|		ПоследниеДокументыНоменклатуры.Номенклатура В(&Номенклатура)) КАК ПоследниеЦены
		|		ПОЛНОЕ СОЕДИНЕНИЕ РегистрБухгалтерии.Хозрасчетный.ОстаткиИОбороты(&ДатаНачала, &ДатаОкончания, , , Счет = ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.ТоварыНаСкладах), , Субконто1 В (&Номенклатура) И Организация = &Организация) КАК ХозрасчетныйОстаткиИОбороты
		|		ПО ((ВЫРАЗИТЬ(ХозрасчетныйОстаткиИОбороты.Субконто1 КАК Справочник.Номенклатура)) = ПоследниеЦены.Номенклатура)
		|
		//+ lud 01/03/23 по обр. №1132 плановая себестоимость для продукции
		//Скорр lud 07/03/23 по обр №1164 в приоритете с/с для продукции из регистра бух.цен. 
		...
		Запрос.УстановитьПараметр("Организация",МЛ.Организация);
...
Функция ПолучитьЗапросМЛ(МассивОбъектов)
	...
	//|		КОГДА ТИПЗНАЧЕНИЯ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента) = ТИП(Документ.ЗаказНаПеремещение)
	//|			ТОГДА ВЫРАЗИТЬ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента КАК Документ.ЗаказНаПеремещение).СкладПолучатель 
	//|		ИНАЧЕ ВЫБОР КОГДА ТИПЗНАЧЕНИЯ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента) = ТИП(Документ.сабМаршрутныйЛист)
	//|			ТОГДА ""Вложенный маршрут: "" + ВЫРАЗИТЬ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.МаршрутДоставки.Наименование КАК Строка(200))  
	//|		ИНАЧЕ сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.Контрагент
	...
	|			ТОГДА ВЫРАЗИТЬ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента КАК Документ.ЗаказНаПеремещение).СкладПолучатель.АдресСкладаДляВыгрузки
	|		ИНАЧЕ ВЫБОР КОГДА ТИПЗНАЧЕНИЯ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента) = ТИП(Документ.сабМаршрутныйЛист)
	|			ТОГДА ВЫРАЗИТЬ(ВЫРАЗИТЬ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента КАК Документ.сабМаршрутныйЛист).АдресТочкиПерегрузки КАК СТРОКА(200))
	|		ИНАЧЕ сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.АдресДоставки
	|	КОНЕЦ КОНЕЦ КАК АдресКлиента,
	|	сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.Телефон КАК Телефон,
	|	ВЫРАЗИТЬ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ЗаданиеВодителю КАК СТРОКА(1000)) КАК ЗаданиеВодителю,
	|	ВЫБОР 
	|		КОГДА ТИПЗНАЧЕНИЯ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента) = ТИП(Документ.сабМаршрутныйЛист)
	|			ТОГДА сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.Менеджер	
	|		ИНАЧЕ сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.МенеджерКонтрагента
	|	КОНЕЦ КАК МенеджерКонтрагента,
	|	сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента КАК ЗаказКлиента,
	|	сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.Дата КАК ЗаказКлиентаДата,
	|	сабМаршрутныйЛистТабличнаяЧасть.Ссылка КАК МаршрутныйЛист,
	|	ВЫБОР 
	|		КОГДА ТИПЗНАЧЕНИЯ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента) = ТИП(Документ.сабМаршрутныйЛист)
	|			ТОГДА сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.Примечание	
	|		ИНАЧЕ сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ПодразделениеКонтрагента.Примечание
	|	КОНЕЦ КАК Примечание,
	|	ВЫБОР 
	|		КОГДА ТИПЗНАЧЕНИЯ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента) = ТИП(Документ.сабМаршрутныйЛист)
	|			ТОГДА """"	
	|		ИНАЧЕ сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ПодразделениеКонтрагента.КодУпорядочивания
	|	КОНЕЦ КАК КодУпорядочивания,
	|	ВЫБОР 
	|		КОГДА ТИПЗНАЧЕНИЯ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента) = ТИП(Документ.сабМаршрутныйЛист)
	|			ТОГДА """"	
	|		ИНАЧЕ ВЫРАЗИТЬ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ЗаданиеСкладу КАК СТРОКА(1000))
	|	КОНЕЦ КАК ЗаданиеСкладу,
	//|	сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ПодразделениеКонтрагента.Примечание КАК Примечание,
	//|	сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ПодразделениеКонтрагента.КодУпорядочивания КАК КодУпорядочивания,
	//|	ВЫРАЗИТЬ(сабМаршрутныйЛистТабличнаяЧасть.ЗаказКлиента.ЗаданиеСкладу КАК СТРОКА(1000)) КАК ЗаданиеСкладу,
	|	сабМаршрутныйЛистТабличнаяЧасть.НомерСтроки КАК ПорядокДоставки
	...
	|	ВТ_Заказ.ЗаданиеВодителю,
	|	ВТ_Заказ.МенеджерКонтрагента,
	|	""Груз маршрутного листа № "" + сабМаршрутныйЛист.Номер, 
	|	0,
	|	сабМаршрутныйЛист.Вес КАК Вес,
	|	ВТ_Заказ.ЗаказКлиентаДата КАК ЗаказКлиентаДата,
	|	ВТ_Заказ.МаршрутныйЛист КАК МаршрутныйЛист,
	|	сабМаршрутныйЛист.Вес КАК ВесФ,
	|	0 КАК КоличествоФ,
	|	ВТ_Заказ.КодУпорядочивания КАК КодУпорядочивания,
	|	ВТ_Заказ.ЗаданиеСкладу КАК ЗаданиеСкладу,
	|	ВТ_Заказ.ПорядокДоставки КАК ПорядокДоставки,
	...
	|		ПО ВТ_Заказ.ЗаказКлиента = сабМаршрутныйЛист.Ссылка
	//|ГДЕ
	//|	НЕ ЗаказНаПеремещениеТабличнаяЧасть.Номенклатура ЕСТЬ NULL
	|	
	|ОБЪЕДИНИТЬ ВСЕ
	...
	|	ВТ_ЗаказПлюсТЧБегГрупп КАК ВТ_ЗаказПлюсТЧБегГрупп
	|
	|ГДЕ НЕ ВТ_ЗаказПлюсТЧБегГрупп.Номенклатура ЕСТЬ NULL 
	|
	|СГРУППИРОВАТЬ ПО
	|	ВТ_ЗаказПлюсТЧБегГрупп.ДатаОтгрузки,
	|	ВТ_ЗаказПлюсТЧБегГрупп.ДатаДоставки,
	...
	Запрос.УстановитьПараметр("МассивОбъектов", МассивОбъектов);
	Запрос.УстановитьПараметр("ФормаФакт", Истина);
	Запрос.УстановитьПараметр("ВидМобТелефон", Справочники.ВидыКонтактнойИнформации.ТелефонМобильныйФизическиеЛица);
...
Функция ПолучитьРеквизитыШапки(МЛ)
	
	РеквзитыШапки = Новый Структура;
	
	Запрос = Новый Запрос;
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	сабМаршрутныйЛист.ВремяНачалаПогрузки КАК ВремяНачалаПогрузки,
		|	сабМаршрутныйЛист.Доставщик КАК Доставщик,
		|	сабМаршрутныйЛист.ОтветственныйЗаНаборку КАК ОтветственныйЗаНаборку
		|ИЗ
		|	Документ.сабМаршрутныйЛист КАК сабМаршрутныйЛист
		|ГДЕ
		|	сабМаршрутныйЛист.Ссылка = &Ссылка";
	...
	Если ВыборкаДетальныеЗаписи.Следующий() тогда
		РеквзитыШапки.Вставить("ВремяНачалаПогрузки",Формат(ВыборкаДетальныеЗаписи.ВремяНачалаПогрузки,"ДФ=ЧЧ:мм"));
		РеквзитыШапки.Вставить("ФИОВодителя",ВыборкаДетальныеЗаписи.Доставщик);
		РеквзитыШапки.Вставить("ОтветственныйЗаНаборку",ВыборкаДетальныеЗаписи.ОтветственныйЗаНаборку)
	КонецЕсли;
	
	Возврат РеквзитыШапки;
	
КонецФункции

Функция ПолучитьМаршрутДоставки(МЛ)
	
	МаршрутДоставки = "";
	Запрос = Новый Запрос;
	Запрос.Текст = "ВЫБРАТЬ
	               |	сабМаршрутыДоставки.МашрутДоставки.Наименование КАК МашрутДоставки,
	               |	сабМаршрутыДоставки.НомерВОчереди КАК НомерВОчереди
	               |ИЗ
	               |	РегистрСведений.сабМаршрутыДоставки КАК сабМаршрутыДоставки
	               |ГДЕ
	               |	сабМаршрутыДоставки.Документ = &Документ
	               |
	               |УПОРЯДОЧИТЬ ПО
	               |	НомерВОчереди";
	
	Запрос.УстановитьПараметр("Документ",МЛ);
	Выборка = Запрос.Выполнить().Выбрать();
	МаршрутДоставкиСтрока = "";	
	Первый = Истина;	
	Пока Выборка.Следующий() цикл
		Если Первый тогда
			МаршрутДоставки = Выборка.МашрутДоставки;
			Первый = Ложь;
		иначе 
			МаршрутДоставки = МаршрутДоставки + "; " + Выборка.МашрутДоставки; 
		КонецЕсли;
	КонецЦикла;
