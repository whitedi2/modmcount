					...
					Пока ВыборкаКонтрагент.Следующий() Цикл
						...
						Пока ВыборкаАдрес.Следующий() Цикл
							...
							Пока ВыборкаЗаказКлиента.Следующий() Цикл
								...
								Если НЕ ИмяКоманды = "Документ.сабМаршрутныйЛист.Команда.МаршрутныйЛистНаборЗаказаВесовой"
									И НЕ ИмяКоманды = "Документ.сабМаршрутныйЛист.Команда.МаршрутныйЛистНовыйФакт" Тогда  //ПЕ
