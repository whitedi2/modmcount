...
Процедура ТабличнаяЧастьЗаказКлиентаПриИзменении(Элемент)
	...
	Если Не Элемент = Неопределено Тогда
		...
		Если ТипЗнч(Элемент.ТекущиеДанные.ЗаказКлиента) = Тип("ДокументСсылка.ЗаказКлиента") Или ТипЗнч(Элемент.ТекущиеДанные.ЗаказКлиента) = Тип("ДокументСсылка.ЗаказНаВозвратОтКлиента") Тогда			
			Элемент.ТекущиеДанные.Статус = ПредопределенноеЗначение("Перечисление.СтатусыЗаказовКлиентов.ПустаяСсылка");
		ИначеЕсли ТипЗнч(Элемент.ТекущиеДанные.ЗаказКлиента) = Тип("ДокументСсылка.ЗаказПоставщику") Или ТипЗнч(Элемент.ТекущиеДанные.ЗаказКлиента) = Тип("ДокументСсылка.ЗаказНаПеремещение") Тогда	
			Элемент.ТекущиеДанные.Статус = ПредопределенноеЗначение("Перечисление.СтатусыЗаказовПоставщикам.ПустаяСсылка");
		КонецЕсли;
...
&НаКлиенте
Процедура ТабличнаяЧастьЗаказКлиентаОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	а=1;
КонецПроцедуры
