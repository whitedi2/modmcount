...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	//Если НЕ ВидОперации = Перечисления.ВидыПеремещений.ПоступлениеСОбособленногоПодразделения И (Не НеКонтролироватьОстатки = Истина) И НЕ НеКонтролироватьОстаткиСвойство И НЕ Пользователи.РолиДоступны("допОтключитьКонтрольОстатков",,Ложь) Тогда
