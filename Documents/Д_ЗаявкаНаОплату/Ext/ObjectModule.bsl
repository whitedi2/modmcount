	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура") Тогда
		Если ДанныеЗаполнения.Свойство("ДатаГрафика") Тогда //формируем по графику платежей на дату
			...
			Пока Выборка.Следующий() Цикл
				...
				Если ТипЗнч(Выборка.ЗаявкаНаФинансирование) = Тип("ДокументСсылка.Д_ЗаявкаНаФинансирование") Тогда
					НоваяСтрока.ДокументОснование = Выборка.ЗаявкаНаФинансирование.ДокОснование;				
				КонецЕсли;
