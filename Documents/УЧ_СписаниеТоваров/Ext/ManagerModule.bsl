...
Функция ПечатьАктаСписанияТоваров(МассивОбъектов) Экспорт
	...
	Запрос = Новый Запрос("ВЫБРАТЬ РАЗРЕШЕННЫЕ
	                      ...
	                      |			ТОГДА Документ.Подразделение.Организация
	                      ...
	                      |	ПРЕДСТАВЛЕНИЕ(Документ.Подразделение) КАК ОрганизацияПредставление,
	...
	ОбластьШапкаТаблицыКолонкаСерии 	= Макет.ПолучитьОбласть("ШапкаТаблицы|СерияНоменклатуры");
	ОбластьСтрокаТаблицыКолонкаСерии 	= Макет.ПолучитьОбласть("СтрокаТаблицы|СерияНоменклатуры");
	ОбластьПодвалТаблицыКолонкаСерии 	= Макет.ПолучитьОбласть("ПодвалТаблицы|СерияНоменклатуры");
	...
	Если НЕ СерииНоменклатурыИспользуются тогда
		...
		ОбластьКолонкаТоваров.ШиринаКолонки = ОбластьКолонкаТоваров.ШиринаКолонки + Макет.Область("СерияНоменклатуры").ШиринаКолонки;
	...
	Пока ВыборкаПоДокументам.Следующий() Цикл
		...
		Если СерииНоменклатурыИспользуются тогда 
			...
			ТабличныйДокумент.Присоединить(ОбластьШапкаТаблицыКолонкаСерии);
		...
		Пока ВыборкаПоСтрокамТЧ.Следующий() Цикл
			...
			Если СерииНоменклатурыИспользуются тогда 
				...
				ОбластьСтрокаТаблицыКолонкаСерии.Параметры.СерияНоменклатуры = ВыборкаПоСтрокамТЧ["СерияНоменклатуры"];
				ТабличныйДокумент.Присоединить(ОбластьСтрокаТаблицыКолонкаСерии);
		...
		Если СерииНоменклатурыИспользуются Тогда
			...
			ТабличныйДокумент.Присоединить(ОбластьПодвалТаблицыКолонкаСерии);
