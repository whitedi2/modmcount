...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.УЧ_Реализация") Тогда
		...
		Для Каждого ТекСтрокаВерхи Из ДанныеЗаполнения.Верхи Цикл
			НоваяСтрока = Верхи.Добавить();
			НоваяСтрока.ВерхКонтрагента = ТекСтрокаВерхи.ВерхКонтрагента;
			НоваяСтрока.ДоговорМенеджера = ТекСтрокаВерхи.ДоговорМенеджера;
			НоваяСтрока.Комментарий = ТекСтрокаВерхи.Комментарий;
			НоваяСтрока.Статья = ТекСтрокаВерхи.Статья;
			НоваяСтрока.Сумма = ТекСтрокаВерхи.Сумма;
		КонецЦикла;
		Для Каждого ТекСтрокаРеализация Из ДанныеЗаполнения.Реализация Цикл
			НоваяСтрока = Товары.Добавить();
			НоваяСтрока.Количество = ТекСтрокаРеализация.Количество;
			НоваяСтрока.КоличествоКРХ = ТекСтрокаРеализация.КоличествоКРХ;
			НоваяСтрока.Номенклатура = ТекСтрокаРеализация.Номенклатура;
			НоваяСтрока.Склад = ТекСтрокаРеализация.Склад;
			НоваяСтрока.СуммаОтгрузки = ТекСтрокаРеализация.СуммаОтгрузки;
			НоваяСтрока.Счет = ТекСтрокаРеализация.Счет;
			НоваяСтрока.Цена = ТекСтрокаРеализация.Цена;
			НоваяСтрока.КорСчет = ТекСтрокаРеализация.КорСчет;
			НоваяСтрока.КорСубконто1 = ТекСтрокаРеализация.КорСубконто1;
			НоваяСтрока.КорСубконто2 = ТекСтрокаРеализация.КорСубконто2;
			НоваяСтрока.КорСубконто3 = ТекСтрокаРеализация.КорСубконто3;
			НоваяСтрока.СуммаДоставкиНачислено = ТекСтрокаРеализация.СуммаДоставкиНачислено;
		КонецЦикла;
	КонецЕсли;
	//}}__КОНСТРУКТОР_ВВОД_НА_ОСНОВАНИИ
