...
Процедура Кредиты()
	...
	СтатьяПолученияКредита = Справочники.СтатьиДвиженияДенежныхСредств.НайтиПоКоду("1600.01");
	СтатьяПогашенияКредита = Справочники.СтатьиДвиженияДенежныхСредств.НайтиПоКоду("2220.01"); 
	СтатьяПогашенияПроцентовПоКредиту = Справочники.СтатьиДвиженияДенежныхСредств.НайтиПоКоду("2110.01"); 
