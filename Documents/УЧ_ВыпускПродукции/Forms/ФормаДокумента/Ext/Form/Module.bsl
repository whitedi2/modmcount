	...
	Если ЗначениеЗаполнено(ТекСпецификация) Тогда
		...
		Для Каждого СоставСпецификаций Из НайденныйСоставСпецификаций Цикл
			...
			Если СоставПодчиненнойСпецификации.Количество() > 0 Тогда
				Для Каждого СтрокаПодчиненнойСпецификации Из СоставПодчиненнойСпецификации Цикл
					...
					Если СоставПодчиненнойСпецификации2.Количество() > 0 Тогда
						Для Каждого СтрокаПодчиненнойСпецификации2 Из СоставПодчиненнойСпецификации2 Цикл
								...
								Для Каждого СтрокаПодчиненнойСпецификации3 Из СоставПодчиненнойСпецификации3 Цикл
									...
									Если СоставПодчиненнойСпецификации4.Количество() > 0 Тогда
										Для Каждого СтрокаПодчиненнойСпецификации4 Из СоставПодчиненнойСпецификации4 Цикл
											...
											СтрокаТаблМатериалов.Сумма = СтрокаПодчиненнойСпецификации4.Количество*СтрокаПодчиненнойСпецификации4.Цена;//СтрокаПодчиненнойСпецификации4.Сумма;
									...
									Иначе
										...
										СтрокаТаблМатериалов.Сумма = СтрокаПодчиненнойСпецификации3.Количество*СтрокаПодчиненнойСпецификации3.Цена;//СтрокаПодчиненнойСпецификации3.Сумма;
							...
							Иначе
								...
								СтрокаТаблМатериалов.Сумма = СтрокаПодчиненнойСпецификации2.Количество*СтрокаПодчиненнойСпецификации2.Цена;//СтрокаПодчиненнойСпецификации2.Сумма;
					...
					Иначе
						...
						СтрокаТаблМатериалов.Сумма = СтрокаПодчиненнойСпецификации.Количество*СтрокаПодчиненнойСпецификации.Цена;//СтрокаПодчиненнойСпецификации.Сумма;
			...
			Иначе
				...
				СтрокаТаблМатериалов.Сумма = СоставСпецификаций.Количество*СоставСпецификаций.Цена;//СоставСпецификаций.Сумма;
