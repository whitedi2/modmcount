...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользуютсяСМП = (Метаданные.Имя = "БухгалтерияСтроительнойОрганизацииКОРП" ИЛИ Метаданные.Имя = "БухгалтерияСтроительнойОрганизации");
...
Процедура СтатусСогласованоНаСервере(Заявки, ИмяКоманды)
	...
	Если ИмяКоманды = "СтатусСогласовано" Тогда
		Точка = Перечисления.СтатусыЗаявокНаОплату.Согласовано;
	ИначеЕсли ИмяКоманды = "СтатусНеСогласовано" Тогда
		Точка = Перечисления.СтатусыЗаявокНаОплату.НеСогласовано;
	ИначеЕсли ИмяКоманды = "СтатусКОплате" Тогда
		Точка = Перечисления.СтатусыЗаявокНаОплату.КОплате;
	ИначеЕсли ИмяКоманды = "СтатусОтменено" Тогда
		Точка = Перечисления.СтатусыЗаявокНаОплату.Отменено;
	Иначе
		Точка = Перечисления.СтатусыЗаявокНаОплату.НеСогласовано;
	КонецЕсли;
