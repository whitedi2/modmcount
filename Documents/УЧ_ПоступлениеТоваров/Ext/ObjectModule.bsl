...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Иначе
		Для Каждого ТекСтрокаТабличнаяЧасть Из ТабличнаяЧасть Цикл
			...
			ТекСуммаСтрока = ?(УчитыватьНДС, ?(СуммаВключаетНДС, ТекСтрокаТабличнаяЧасть.Сумма - ТекСтрокаТабличнаяЧасть.СуммаНДС, ТекСтрокаТабличнаяЧасть.Сумма), ТекСтрокаТабличнаяЧасть.Сумма) * КурсВалюты / КратностьВзаиморасчетов;
			...
			Если УчитыватьНДС И ТекСтрокаТабличнаяЧасть.СуммаНДС Тогда
				...
				Движение.Сумма = ТекСтрокаТабличнаяЧасть.СуммаНДС * КурсВалюты  / КратностьВзаиморасчетов;
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.УЧ_Реализация") Тогда
		...
		Организация = ДанныеЗаполнения.Контрагент.ЭтоОрганизация;
